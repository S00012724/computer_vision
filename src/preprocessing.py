"""Image preprocessing helpers for CNN and ResNet50 inputs"""
...
# 96 x 96 keeps training small while retaining enough bin shape and fill detail
# for this dataset.
...
def image_to_cnn_tensor(
    ...
    """Convert a BGR OpenCV image to a normalized RGB CNN tensor
...
def records_to_tensors(
    ...
    """Load image records into CNN tensors and integer labels
...
def apply_resnet50_preprocessing(inputs: Any) -> Any:
    """Convert RGB tensors to ResNet50's BGR ImageNet format
